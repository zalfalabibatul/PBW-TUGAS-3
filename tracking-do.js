    ...
    <div class="tracking-wrap">
      ...
      <div class="tracking-search-bar">
        <div class="search-input-wrap">
          ...
          <input type="search" v-model="searchDO" placeholder="Cari nomor DO / NIM..." @keydown.enter.prevent @keyup.escape="searchDO=''">
        </div>
        <span v-show="searchDO" class="search-clear" @click="searchDO=''">
  ...
  `,
    ...
    computed: {
        ...
        nextDoNumber: function() {
            ...
            var num = String(next).padStart(3, '0');
            return 'DO' + year + '-' + num;
        },
